...
8. 正文仍是按原论文结构逐段翻译，不得用总结、导读、解读或精读讲义替代原文翻译。
9. 加法阅读层中的额外解释必须是 XML callout，不得以 Markdown `>` blockquote 残留在正文。
...
- 抽样检查每个主章节前 2-3 个正文段落，确认它们对应原文段落翻译，而不是“本节主要说明...”式总结或精读讲义。
