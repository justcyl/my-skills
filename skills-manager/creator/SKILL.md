...
1. 仓库根目录固定为 `MY_SKILLS_REPO_ROOT`
   默认值：`/Users/chenyl/project/my-skills`
...
```bash
python skills-manager/creator/scripts/package_skill.py /Users/chenyl/project/my-skills/<skill-id>
```

也可以显式指定输出目录：

```bash
python skills-manager/creator/scripts/package_skill.py /Users/chenyl/project/my-skills/<skill-id> /Users/chenyl/project/my-skills/.skills/packages
```
